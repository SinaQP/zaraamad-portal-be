...
_HTTP_EXCEPTION_DEVELOPER_MESSAGES = {
    ...
    messages.FORM_ADMIN_ACCESS_REQUIRED: "Authenticated user does not have form-admin access.",
    messages.INVALID_BRIDGE_KEY: "Provided X-Bridge-Key header did not match the configured bridge API key.",
    messages.REMOTE_AUTH_UNAVAILABLE: "Remote bearer token introspection could not be completed.",
    messages.REMOTE_AUTH_INVALID_RESPONSE: "Remote bearer token introspection returned an invalid payload.",
    ...
    messages.FORM_NOT_FOUND: "Requested form schema record was not found.",
    messages.FORM_FIELD_NOT_FOUND: "Requested form field record was not found.",
    messages.FORM_FIELD_PARENT_INVALID: "The supplied parent field is invalid for the target form or creates a cycle.",
